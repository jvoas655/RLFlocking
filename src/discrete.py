...
if __name__ == "__main__":
    ...
    if not args.show:
        ...
        writer = SummaryWriter('officialruns/'+run_name)
    ...
    while (algo.episode_done < args.num_episodes):
        ...
        if args.show:
            ...
            env.display_last_episode(test_string)
            algo.episode_done += 1
            continue
        ...
        writer.add_scalar('Rewards/train', train_total_reward, algo.episode_done) 
        writer.add_scalar('Collisions/train', train_total_reward, algo.episode_done) 
        writer.add_scalar('Density/train', train_total_reward, algo.episode_done) 
        writer.add_scalar('Density2/train', train_total_reward, algo.episode_done) 
